...
class ProductoController {
    ...
    public function guardar() {
        ...
        try {
            ...
            if(isset($_POST['modificadores']) && is_array($_POST['modificadores'])){
    ...
    public function actualizar() {
        ...
        try {
            ...
            // 2. Actualizar modificadores (recrea todo)
            if(isset($_POST['modificadores'])){
                $this->service->actualizarModificadores($id, $_POST['modificadores']);
            }
